...
/** \file
 *
 *  Input classes for the Velodyne HDL-32E 3D LIDAR:
 *
...
{
  static const size_t packet_size = sizeof(velodyne_gps_driver::VelodyneGPSPacket().data);
  ...
  int InputSocket::getPacket(velodyne_gps_driver::VelodyneGPSPacketPtr pkt)
  {
  ...
  /** @brief Get one velodyne packet. */
  int InputPCAP::getPacket(velodyne_gps_driver::VelodyneGPSPacketPtr pkt)
  {
