"""autogenerated by genpy from BP/DetectBallsRequest.msg. Do not edit."""
import sys
...
"""autogenerated by genpy from BP/DetectBallsResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class DetectBallsResponse(genpy.Message):
  ...
  _type = "BP/DetectBallsResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """BP/Detections detections
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.detections is None:
        self.detections = BP.msg.Detections()
    else:
      self.detections = BP.msg.Detections()
